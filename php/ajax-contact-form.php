...
class Ajax_Contact_Form {
     ...
     * @var string
     */
    protected $address_destination = 'devunity62400@gmail.com';  /*  Production - lardet.brigitte@orange.fr */
     ...
     * @var string
     */
    protected $message_subject = 'Prise de contact depuis le site';
    ...
    protected $strings = array(
        ...
        'success'           => 'Je vous remercie! nous allons prendre contact avec vous rapidement.',
        'error'             => 'Désolé, une erreur s\'est produite lors de l\'envoi de votre message. S\'il vous plaît vérifier la configuration du serveur PHP mail.',
        'demo'              => 'This is demo message from PHP',
        'header_injection'  => 'Injection d\'en-tête détectée.',
        'enter_name'        => 'S\'il vous plaît entrez votre nom.',
        'enter_email'       => 'S\'il vous plaît entrez votre email.',
        'enter_message'     => 'S\'il vous plaît entrez un message.',
        'ajax_only'         => 'Autorisé uniquement XMLHttpRequest.',
    );
